...
function ChangePassword() {
  ...
  return (
    <div className="changePassword">
      ...
      <Typography className="changePassword__plainText" variant="h5" component="h2">Enter your email to reset your password.</Typography>
{/* 
      <Field
        isRequired
      ...
      <Button
        ...
        onClick={submitForm}
        className="changePassword__changePasswordBtn"
      >
        {t("changePassword")}
      </Button>
    </div>
