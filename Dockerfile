...
COPY --chown=node --from=builder /usr/local/src/appsrc/server/yoti/landOfSneakers-access-security.pem /usr/local/src/app/programs/server/server/yoti/landOfSneakers-access-security.pem
