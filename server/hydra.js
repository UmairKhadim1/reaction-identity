...
const get = async (flow, challenge) => {
  console.log("flow, challenge",flow, challenge)
  try {
    ...
    console.log("hydra error get",err)
    Logger.error(
...
const put = async (flow, action, challenge, body) => {
  ...
  console.log("hydra res put",res)
    ...
    console.log("hydra error put",err)
